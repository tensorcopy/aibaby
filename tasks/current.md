...
### MVP vertical slice
- AIB-020 `in_progress` Build baby profile create/edit flow (current slice: bind grouped choice sections directly in the route model to remove screen-level branching)
