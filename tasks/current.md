...
### MVP vertical slice
- AIB-020 `in_progress` Build baby profile create/edit flow (current slice: add reusable form-flow helpers that load defaults, compute age summary, and PATCH only changed fields)
