...
### MVP vertical slice
- AIB-020 `in_progress` Build baby profile create/edit flow (current slice: wire authenticated current-profile bootstrap and session context into the Expo shell)
