...
### MVP vertical slice
- AIB-020 `in_progress` Build baby profile create/edit flow (current slice: wrap mobile/web helpers in real Expo + App Router handlers once app scaffolds land)
