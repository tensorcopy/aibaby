...
### MVP vertical slice
- AIB-020 `in_progress` Build baby profile create/edit flow (current slice: claim Expo Router bootstrap and root navigation entry points around the existing route shell)
